...
class QuranBookmarkPagerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        bookmarksList = sharedPreferences.getStringSet(Constants.KEY_QURAN_BOOKMARKS, setOf<String>())
            ?.toMutableList()
    ...
    inner class Adapter : RecyclerView.Adapter<Adapter.ViewHolder>() {
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view =
                LayoutInflater.from(parent.context).inflate(R.layout.row_quran_bookmark, parent, false)
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            val surah = surahs[holder.surahIndex]
            val ayah = surah.ayahs[holder.ayahIndex]
            holder.tvNo.text = ayah.juz.toString()
            holder.tvSurah.text = ayah.text
            holder.tvVerse.text = "Surah ${surah.englishName}, Ayah " + (ayah.numberInSurah)
        }
